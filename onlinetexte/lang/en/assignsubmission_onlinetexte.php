...
/**
 * Strings for component 'assignsubmission_onlinetexte', language 'en'
 *
...
$string['allowonlinetextesubmissions'] = 'Enabled';
$string['default'] = 'Enabled by default';
$string['default_help'] = 'If set, this submission method will be enabled by default for all new assignments.';
$string['enabled'] = 'Online text enhanced';
...
$string['onlinetexte'] = 'Online text enhanced';
$string['onlinetextefilename'] = 'onlinetexte.html';
$string['onlinetextesubmission'] = 'Allow online text submission';
$string['numwords'] = '({$a} words)';
$string['numwordsforlog'] = 'Submission word count: {$a} words';
$string['pluginname'] = 'Online text enhanced submissions';
