 ...
 */
class assignsubmission_onlinetexte_generator extends assignsubmission_subplugin_generator {
    /**
    ...
    public function add_submission_data(stdClass $submission, assign $assign, array $data): void {
        if (array_key_exists('onlinetexte', $data)) {
            $submission->onlinetexte_editor = [
                'itemid' => file_get_unused_draft_itemid(),
                'text' => $data['onlinetexte'],
                'format' => FORMAT_HTML,
            ];
        }
    }
