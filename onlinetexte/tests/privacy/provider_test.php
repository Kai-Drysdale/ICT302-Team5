...
/**
 * Unit tests for assignsubmission_onlinetexte.
 *
...
/**
 * Unit tests for mod/assign/submission/onlinetexte/classes/privacy/
 *
 * @copyright  2018 Adrian Greeve <adrian@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class provider_test extends \mod_assign\privacy\provider_test {
    ...
    protected function create_online_submission($assign, $student, $text) {
        ...
        $plugin = $assign->get_submission_plugin_by_type('onlinetexte');
    ...
    public function test_get_metadata() {
        $collection = new \core_privacy\local\metadata\collection('assignsubmission_onlinetexte');
        $collection = \assignsubmission_onlinetexte\privacy\provider::get_metadata($collection);
    ...
    public function test_export_submission_user_data() {
        ...
        \assignsubmission_onlinetexte\privacy\provider::export_submission_user_data($exportdata);
        $this->assertEquals($submissiontext, $writer->get_data(['Attempt 1',
                get_string('privacy:path', 'assignsubmission_onlinetexte')])->text);
    }
    ...
    public function test_delete_submission_for_context() {
        ...
        \assignsubmission_onlinetexte\privacy\provider::delete_submission_for_context($requestdata);
    ...
    public function test_delete_submission_for_userid() {
        ...
        \assignsubmission_onlinetexte\privacy\provider::delete_submission_for_userid($requestdata);
    ...
    public function test_delete_submissions() {
        ...
        $data = $DB->get_records('assignsubmission_onlinetexte', ['assignment' => $assign1->get_instance()->id]);
        ...
        \assignsubmission_onlinetexte\privacy\provider::delete_submissions($requestdata);
        ...
        $data = $DB->get_records('assignsubmission_onlinetexte', ['assignment' => $assign2->get_instance()->id]);
